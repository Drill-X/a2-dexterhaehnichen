...
- **Save/restore from file function**: Admins can save the current state of the number and its operation history to a json file, or restore the number and history to a previous state using an existing json file
